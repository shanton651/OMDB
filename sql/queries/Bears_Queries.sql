...
ON
    movies.movie_id = trivia.movie_id
LEFT OUTER JOIN(
    SELECT
        movie_id,
        COUNT(movie_id) AS `quotes`
    FROM
        `movie_quotes`
    GROUP BY
        movie_id ASC
...
ON
    movies.movie_id = quotes.movie_id
LEFT OUTER JOIN(
    SELECT
        movie_id,
        COUNT(movie_id) AS `keywords`
    FROM
        `movie_keywords`
    GROUP BY
        movie_id ASC
...
ON
    movies.movie_id = keywords.movie_id
LEFT OUTER JOIN(
    SELECT
        movie_id,
        COUNT(movie_id) AS `media`
    FROM
        `movie_media`
    GROUP BY
        movie_id ASC
...
ON
    movies.movie_id = media.movie_id
LEFT OUTER JOIN(
    SELECT
        movie_id,
        COUNT(movie_id) AS `songs`
    FROM
        `movie_song`
    GROUP BY
        movie_id ASC
...
ON
    movies.movie_id = song.movie_id
LEFT OUTER JOIN(
    SELECT
        movie_id,
        COUNT(movie_id) AS `people`
    FROM
        `movie_people`
    GROUP BY
        movie_id ASC
...
ON
    movies.movie_id = m_people.movie_id
GROUP BY
    movies.movie_id ASC;
