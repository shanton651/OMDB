...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2020 at 01:24 AM
...
(1, 'local_name_1', 'engish_name_1', 2020),
...
(1, 'Spanish', 'Mexico', 'Thriller', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer aliquet dolor vel arcu tincidunt, vitae lacinia leo semper. Phasellus id iaculis nisi, a faucibus erat. Integer eget lectus ac magna sodales ornare sollicitudin eget enim. Sed risus ante, ultricies id quam eu, scelerisque sodales magna. Aenean interdum id nisl nec suscipit. Cras mattis nulla nec metus tristique, eu pretium purus dignissim. Morbi placerat purus nec dui rhoncus, at pharetra mi iaculis.');
...
(1, 'https://www.google.com', 'image', 1),
(2, 'https://www.youtube.com', 'video', 1);
...
(1, 'John', 'John', '', 'Doe', 'Male', 'john_doe.png'),
(2, 'Joan', 'Joanna', '', 'Doe', 'Female', 'johanna_doe.png'),
(3, 'Jo', 'Joseph', 'vi', 'Minnell', 'Male', 'joe.jpg'),
(4, 'Queen', 'Patricia', 'Graham', 'Donalds', 'Female', 'p.jpg');
...
(1, 'https://google.com', 'audio', 1),
(2, 'https://youtube.com', 'video', 2);
